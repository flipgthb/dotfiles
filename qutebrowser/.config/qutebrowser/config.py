...
## Type: ShellCommand
c.editor.command = ['emacs', '-Q', '{file}'] #['gvim', '-f', '{file}', '-c', 'normal {line}G{column0}l']
...
## Type: Padding
c.statusbar.padding = {'top': 5, 'bottom': 5, 'left': 0, 'right': 10}
...
c.statusbar.widgets = ['keypress', 'progress', 'url', 'scroll', 'history', 'tabs']
...
# My bindings
config.bind(';v', 'hint links spawn mpv --ytdl --ytdl-format best {hint-url}')
