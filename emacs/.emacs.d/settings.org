...
* Current Config
** TODO Things to put in the corret place
#+BEGIN_SRC 
 ;; (defalias 'list-buffers 'ibuffer)    ;; use ibuffer as default buffer list (C-x C-b) - to buffer
 ;; (highlight-indentation-mode -1)     ;; do not highlight indentation - to editing

  ;; (setq-default indent-tabs-mode nil)  ;; never use hard tabs - to editing

  ;; (setq show-paren-delay 0)            ;; immediatly show matching delimiter - to editing
  ;; (show-paren-mode t)                  ;; turn of highlighting of matching delimiters - to editing

  ;; (column-number-mode 1)               ;; show column number in mode line - to mode line
  ;; (setq-default fill-column 80)        ;; number of characters before line wrap - to editing
  ;; (global-visual-line-mode 1)          ;; turn on line wrap on window border - to editing
  ;; (diminish 'visual-line-mode "w↩")   ;; diminish the bulky "Wrap" - to mode line
#+END_SRC
** TODO Things to copy 
